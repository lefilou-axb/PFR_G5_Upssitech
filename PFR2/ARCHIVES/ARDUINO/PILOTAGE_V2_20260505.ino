...
#define DISTANCE_RATIO 0.0008  // À CALIBRER : mètres par milliseconde (exemple: 0.4 m/s)
#define ANGLE_RATIO 0.09    // À CALIBRER : degrés par milliseconde (exemple: 0.12 deg/ms)
